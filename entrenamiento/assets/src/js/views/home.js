        ...
        <div class="container">
            ...
            <div style="text-align: center; padding: 3rem 0;">
                ...
                <p style="font-size: 1.2rem; color: #7f8c8d; margin-bottom: 2rem;">
                    Aprende desde cualquier lugar, a tu propio ritmo
                </p>
                ...
                <div class="courses-grid">
                    ...
                    <div class="course-card">
                        ...
                        <p style="margin-top: 1rem;">
                            Amplio catálogo de cursos en diferentes categorías:
                    ...
                    <div class="course-card">
                        ...
                        <p style="margin-top: 1rem;">
                            ...
                            y demuestra tus nuevas habilidades.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div style="margin-top: 4rem; text-align: center; padding: 2rem; background-color: #ecf0f1; border-radius: 8px;">
                ...
                <p style="color: #7f8c8d; margin-bottom: 1.5rem;">
                    ${userAuthenticated ? 
                        ...
                        'Regístrate gratis y accede a nuestra plataforma de aprendizaje.'
                    }
                </p>
                ${!userAuthenticated ? `
                    <a href="#/register" class="btn btn-success">
            ...
            <footer style="margin-top: 4rem; padding: 2rem 0; text-align: center; border-top: 1px solid #ecf0f1;">
                <p style="color: #95a5a6;">
                    © 2025 Academia de Cursos Online. Todos los derechos reservados.
                </p>
            </footer>
        </div>
    `;
